#!/usr/bin/env bash
# Publish SSHD2368 course site to GitHub Pages.
# Repo: https://github.com/Lazaruschan/2026-1-SSHD2368-MOTION-MEDIA-Group-A01-
#
# Usage:
#   cd Github/SSHD2368
#   ./publish.sh
...
REPO_URL="https://github.com/Lazaruschan/2026-1-SSHD2368-MOTION-MEDIA-Group-A01-.git"
BRANCH="main"
REMOTE="origin"
...
Publish SSHD2368 Motion Media course website.
...
PAGES_URL="https://lazaruschan.github.io/2026-1-SSHD2368-MOTION-MEDIA-Group-A01-/"
echo ""
echo "Done."
echo "Enable Pages (once): repo Settings → Pages → Deploy from branch → main / (root)"
echo "Site URL: $PAGES_URL"
echo "Site password: 20262368"

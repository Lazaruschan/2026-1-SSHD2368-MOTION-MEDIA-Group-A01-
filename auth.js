/**
 * Client-side password gate for the SSHD2368 static site.
 * Not true security (password check runs in the browser) — use for casual course access only.
 *
 * Default password: 20262368
 * To change it, replace PASSWORD_HASH with:
 *   python3 -c "import hashlib; print(hashlib.sha256(b'YOUR_PASSWORD').hexdigest())"
 */
(function () {
  const PASSWORD_HASH =
    "3927bba1be03aada5b449399bdcf4950c3071e040b5eeb062547eae663964f23";
  const STORAGE_KEY = "sshd2368_site_unlocked";
  const TITLE = "SSHD2368 Motion Media";
